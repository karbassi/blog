...
for( var i=0; i \< parts.length; i<span class="underline"></span>)
{
...
for( var i=0; i \< step2.length; i<span class="underline"></span>)
{
step2\[i\] += ';';
...
// convert number into character code value
for( var x=0; x \< step3.length; x<span class="underline"></span>)
{
