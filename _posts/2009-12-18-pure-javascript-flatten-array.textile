...
While working on my current project I needed a way to turn a heavily nested array and flatten it. There are some nice JavaScript libraries that have functions to do so, such as "Underscore's":http://documentcloud.github.com/underscore/ "_.flatten":http://documentcloud.github.com/underscore/#flatten and "Prototype's":http://www.prototypejs.org ".flatten":http://www.prototypejs.org/api/array/flatten to name a few. 
