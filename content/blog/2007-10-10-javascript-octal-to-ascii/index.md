...
for (i = 0; i < c.length; i++) d += String.fromCharCode(c[i])

c = d.replace(/&#x/g, "")
c = c.split(";")
d = ""

for (i = 0; i < c.length; i++) d += String.fromCharCode(parseInt(c[i], 16))

c = unescape(d).split("\\")
d = ""

for (i = 1; i < c.length; i++) d += String.fromCharCode(parseInt(c[i], 8))
